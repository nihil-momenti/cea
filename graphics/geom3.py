"""Geometry module for use with COSC363, 2009.
   Defines Vector3, Point3, Line3, Ray3 and Plane3 classes for
   3D geometry. Emphasis is on clarity and simplicity for
    teaching purposes, not performance."""
...
class Ray3(object):
    ...
    def pos(self, alpha):
        """A point on a ray is start + alpha*dir for alpha positive."""
        if alpha >= 0:
            return self.start + alpha * self.dir
        else:
...
if __name__ == '__main__':
    ...
    # Some simple and arbitrary tests on lines, rays and planes
